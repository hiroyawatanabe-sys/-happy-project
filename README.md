...
| URL | 対象 | 第一声 | 動画 | 支払い方法 |
|---|---|---|---|---|
| `?s=lec` | WEB学校 第9回 受講者 | 第9回の想起（⑥一貫性） | 折りたたみ | 一括／プランアップ |
| `?s=scsc` | SCSC既存顧客 | 都度依頼なら約292,000円 | 折りたたみ | 一括／プランアップ |
| `?s=cue` | SCSC CUE顧客 | 修正チケット約58枚分 | **既定で展開**（唯一の説明者） | カード／銀行振込 |
| なし | 汎用 | 約175箇所の問いかけ | 折りたたみ | 一括／プランアップ |
