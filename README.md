...
- **CTA体系（SSOT準拠）**：最大CTA「取りこぼしを無料で診断する」×4配置（FV／追従75%／最終／Exit Intent 3分岐）。診断後カードは事例・媒体選びガイド・お困り事（アンケート回答で切替）の3枚＋相談帯。ブリッジの処方CTAはカテゴリ別に媒体サービスページへ直行（V・VIはWeb改善＝無料相談へ）、締めCTAは×数で文言をルーティング
...
TOSENレッド正式HEX／GA4プロパティ／実績社名の掲載許諾。
