...
(function () {
  ...
  var SEGMENTS = {
    lec: {
      head: '先日の第9回でお伝えした「死んだCTA」。<br>御社の対象35ページ、<span class="-w-hl">約175箇所</span>の話です。',
      sub: 'あの90分でご覧いただいた型を、御社のサイトへ丸ごと実装します。9月7日まで、<strong>39,750円（税別）</strong>。',
      video: 'closed',  // 90分受講済みのため既定で折りたたむ
      pay: 'scsc'       // ※受講2名がSCSC顧客かCUE顧客かは要確認（原稿 §8）
    },
    scsc: {
      head: '御社の対象35ページにあるCTA、<span class="-w-hl">約175箇所</span>。<br>いま何箇所が「詳しく見る」のままですか。',
      sub: '弊社に都度ご依頼いただくと約292,000円分の工数です。9月7日まで、<strong>39,750円（税別）</strong>で一括代行します。',
      video: 'closed',  // 月次MTGで人が説明するため補助扱い
      pay: 'scsc'
    },
    cue: {
      head: '御社の対象35ページにあるCTA、<span class="-w-hl">約175箇所</span>。<br>いま何箇所が「詳しく見る」のままですか。',
      sub: '修正チケット換算で約58枚分です。9月7日まで、<strong>39,750円（税別）</strong>で一括代行します。',
      video: 'open',    // 対人接点が構造的に無いため、動画が唯一の説明者
      pay: 'cue'
    },
    'default': {
      head: 'あなたのサイトのCTA、<span class="-w-hl">約175箇所</span>。<br>いま何箇所が「詳しく見る」のままですか。',
      sub: '9月7日まで、<strong>39,750円（税別）</strong>で35ページ分を一括代行します。',
      video: 'closed',
      pay: 'scsc'
    }
  };
